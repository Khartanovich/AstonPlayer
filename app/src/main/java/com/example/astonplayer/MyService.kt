package com.example.astonplayer
...
//Главный вопрос - по условию нужно было использовать любой из - foregraund, bind, backgraund servise
//в доках google для управления плеером в foregraund рекомендуют использовать MediaBrowserServiceCompat()
//я мог его использовать?
private const val CHANNEL_ID = "My channel id"

class MyService : Service() {
    private var mediaPlayer: MediaPlayer? = null
    private val listSongs = listOf(R.raw.muzyka1, R.raw.muzyka3, R.raw.muzyka2, R.raw.muzyka4)
